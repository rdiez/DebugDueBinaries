...
for easy reading:
  ...
  perl -MPod::Simple::HTML  -e "\$p = Pod::Simple::HTML->new; \$p->index( 1 ); \$p->output_fh( *STDOUT{IO} ); \$p->force_title('DebugDue'); \$p->parse_file('README.pod');"  >README.html
...
=head1 DebugDue Binaries

For information about the DebugDue project, including installation instructions, please see the source code repository here:

L<< https://github.com/rdiez/DebugDue >>
